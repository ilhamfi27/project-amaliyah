        ...
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <form role="form" action="<?php echo site_url('prodi/update_data'); ?>" method="post">
                <input type="hidden" name="id" value="<?php echo $row->id; ?>">
                <!-- text input -->
                <div class="form-group">
                  <label>Nama Prodi</label>
                  <input type="text" name="nama" value="<?php echo $row->nama; ?>" class="form-control" placeholder="D3 Manajemen Informatika">
                </div>
                <div class="form-group">
