      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-body">
              ...
              <table id="list-prodi" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('prodi/edit/' . $row->id); ?>">
                      <button class="btn btn-primary">
                        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                      </button>
                    </a>
                    <a href="<?php echo site_url('prodi/delete_data/' . $row->id); ?>">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form role="form" action="<?php echo site_url('prodi/add_data'); ?>" method="post">
                <!-- text input -->
                <div class="form-group">
                  <label>Nama Prodi</label>
                  <input type="text" name="nama"class="form-control" placeholder="D3 Manajemen Informatika">
                </div>
                <div class="form-group">
