      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <table id="list-data" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo site_url('hadist/detail/' . $row->id); ?>">
                      <button class="btn btn-success">
                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                      </button>
                    </a>
                    <a href="<?php echo site_url('hadist/edit/' . $row->id); ?>">
                      <button class="btn btn-primary">
                        <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                      </button>
                    </a>
                    <a href="<?php echo site_url('hadist/delete_data/' . $row->id); ?>">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <form role="form" action="<?php echo site_url() ?>hadist/add_data" method="post">
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>Isi</label>
                  <textarea name="isi" id="isi-hadist" class="form-control"></textarea>
                </div>
                <div class="form-group">
                  <label>Riwayat</label>
                  <input type="text" name="riwayat"class="form-control" placeholder="Riwayat">
                </div>
                <div class="form-group">
