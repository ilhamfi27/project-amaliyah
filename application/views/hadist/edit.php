      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-danger">
            ...
            <div class="box-body">
              <?php foreach($hadist as $row): ?>
                <form role="form" action="<?php echo site_url() ?>hadist/update_data" method="post">
                  <input type="hidden" name="id" value="<?php echo $row->id; ?>">
                  <!-- text input -->
                  <div class="form-group">
                    <label>Perihal</label>
                    <input type="text" name="perihal" value="<?php echo $row->perihal; ?>" class="form-control" placeholder="Perihal">
                  </div>
                  <div class="form-group">
                    <label>Isi</label>
                    <textarea name="isi" id="isi-hadist" class="form-control"><?php echo $row->isi; ?></textarea>
                  </div>
                  <div class="form-group">
                    <label>Riwayat</label>
                    <input type="text" name="riwayat" value="<?php echo $row->riwayat; ?>" class="form-control" placeholder="Riwayat">
                  </div>
                  <div class="form-group">
